...
public final class Constants {
  //call neos here//
  public static CANSparkMax shooterLeft = new CANSparkMax(50, CANSparkLowLevel.MotorType.kBrushless);
  public static CANSparkMax shooterRight = new CANSparkMax(51, CANSparkLowLevel.MotorType.kBrushless);

  public static CANSparkMax intakeMotorIn = new CANSparkMax(52, CANSparkLowLevel.MotorType.kBrushless);
  public static CANSparkMax intakeMotorUp = new CANSparkMax(53, CANSparkLowLevel.MotorType.kBrushless);

  public static CANSparkMax wenchMotor = new CANSparkMax(54, CANSparkLowLevel.MotorType.kBrushed);

  public static CANSparkMax climberLeft = new CANSparkMax(55, CANSparkLowLevel.MotorType.kBrushless);
 ...
 // Always ensure Gyro is CCW+ CW-
    ...
    public static double maxSpeed = 8; // meters per second
  ...
  //public static final SensorDirectionValue cancoderInvert = chosenModule.cancoderInvert;
    ...
    public static final class Mod0 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-62.225);
    ...
    public static final class Mod1 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-103.86);
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class Mod3 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(3.339);
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
  }
